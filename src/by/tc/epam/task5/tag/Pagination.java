...
public class Pagination extends SimpleTagSupport {
    ...
    private String createForm(int page){
        ...
        form.append("<td>").append("<form action=\"ParserServlet\" method=\"get\">")
                .append("<input type=\"submit\" name=\"page\" value = \"").append(page).append("\" >")
                .append("<input type=\"hidden\" name=\"parsType\" value = \"").append(parsType).append("\" >")
